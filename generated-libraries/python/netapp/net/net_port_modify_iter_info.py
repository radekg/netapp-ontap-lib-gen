...
class NetPortModifyIterInfo(NetAppObject):
    """
    Information about the modify operation that was
    attempted/performed against given network port object.
    ...
    def net_key(self):
        """
        The keys for the given network port object to which the
    ...
    @staticmethod
    def get_api_name():
          return "net-port-modify-iter-info"
    ...
    def describe_properties(self):
        return {
            ...
            'net_key': { 'class': NetPortInfo, 'is_list': False, 'required': 'required' },
