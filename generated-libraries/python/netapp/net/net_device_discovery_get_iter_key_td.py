...
class NetDeviceDiscoveryGetIterKeyTd(NetAppObject):
    """
    Key typedef for table net_device_discovery
    """
    ...
    @staticmethod
    def get_api_name():
          return "net-device-discovery-get-iter-key-td"
