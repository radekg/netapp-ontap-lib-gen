...
class FileDirectorySecurityNtfsSaclGetIterKeyTd(NetAppObject):
    """
    Key typedef for table fsecurity_ntfs_security_descriptor_sacl
    """
    ...
    @staticmethod
    def get_api_name():
          return "file-directory-security-ntfs-sacl-get-iter-key-td"
