...
class FileDirectorySecurityNtfsDaclGetIterKeyTd(NetAppObject):
    """
    Key typedef for table fsecurity_ntfs_security_descriptor_dacl
    """
    ...
    @staticmethod
    def get_api_name():
          return "file-directory-security-ntfs-dacl-get-iter-key-td"
