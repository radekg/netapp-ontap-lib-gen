...
class FileDirectorySecurityPolicyTaskGetIterKeyTd(NetAppObject):
    """
    Key typedef for table fsecurity_policy_task
    """
    ...
    @staticmethod
    def get_api_name():
          return "file-directory-security-policy-task-get-iter-key-td"
