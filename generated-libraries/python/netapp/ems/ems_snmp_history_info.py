...
class EmsSnmpHistoryInfo(NetAppObject):
    """
    EMS SNMP History Info
    ...
    _snmp_address = None
    @property
    def snmp_address(self):
        """
        The SNMP client address.
        Attributes: non-creatable, non-modifiable
        """
        return self._snmp_address
    @snmp_address.setter
    def snmp_address(self, val):
        if val != None:
            self.validate('snmp_address', val)
        self._snmp_address = val
    ...
    def describe_properties(self):
        return {
            ...
            'snmp_address': { 'class': basestring, 'is_list': True, 'required': 'optional' },
