...
class ReadHistogramEntry(NetAppObject):
    """
    Histogram of read operations of size 4k in percentage value.
    """
    ...
    def bin_value(self):
        """
        Read histogram bin percentage value.
        Attributes: non-creatable, non-modifiable
        """
