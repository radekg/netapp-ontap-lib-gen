...
class AvOnDemandCommandScanDirInfo(NetAppObject):
    """
    ondemand command
    ...
    def scan_path(self):
        """
        Full path name of the directory to be scanned.
    ...
    def enable_subdirectory_recursion(self):
        ...
        parameter is set to true, recursive scanning is not
    ...
    def enable_junction_following(self):
        ...
        set to true, following junctions is not allowed. To allow
        the scan to follow junctions, set this parameter to
    ...
    @staticmethod
    def get_api_name():
          return "av-on-demand-command-scan-dir-info"
