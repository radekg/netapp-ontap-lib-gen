...
class AvOnDemandCommandScanClusterInfo(NetAppObject):
    """
    ondemand command
    ...
    def directory_pattern(self):
        ...
        expression that defines what directories      to include
        or exclude from the antivirus scan. If this parameter is
        used, you must specify whether to include or exclude
        directories using the include-directories paramete
        r.
    ...
    def enable_subdirectory_recursion(self):
        ...
        parameter is set to true, recursive s          canning is
        not enabled. To allow recursive scanning, set this
        parameter to false. Default is false.
        Attributes: optional-for-create, modifiable
        """
    ...
    def file_pattern(self):
        ...
        defines what files to include or exc          lude from
        the antivirus scan. If this parameter is used, you must
    ...
    def enable_junction_following(self):
        ...
        set to true, following ju          nctions is not
        allowed. To allow the scan to follow junctions, set this
        parameter to false. Default is false.
        Attributes: optional-for-create, modifiable
        """
    ...
    _vserver_pattern = None
    @property
    def vserver_pattern(self):
        """
        This parameter specifies the case-insensitive regular
        expression that defines what Vservers to include or
        exclude from the antivirus scan. If this parameter is
        used, you must specify whether to include or exclude
        Vservers using the include-vservers parameter.
        Attributes: optional-for-create, modifiable
        """
        return self._vserver_pattern
    @vserver_pattern.setter
    def vserver_pattern(self, val):
        if val != None:
            self.validate('vserver_pattern', val)
        self._vserver_pattern = val
    ...
    _include_vservers = None
    @property
    def include_vservers(self):
        """
        This specifies whether the files defined in the parameter
        vserver-pattern will be included in or excluded from the
        antivirus  scan.  If true, then vserver-pattern is an
        inclusive match, else an exclusive match.  Default it
        true.
        Attributes: optional-for-create, modifiable
        Possible values:
        ...
        """
        return self._include_vservers
    @include_vservers.setter
    def include_vservers(self, val):
        if val != None:
            self.validate('include_vservers', val)
        self._include_vservers = val
    
    @staticmethod
    def get_api_name():
          return "av-on-demand-command-scan-cluster-info"
    ...
    def describe_properties(self):
        return {
            ...
            'vserver_pattern': { 'class': basestring, 'is_list': False, 'required': 'optional' },
            ...
            'include_vservers': { 'class': basestring, 'is_list': False, 'required': 'optional' },
        }
