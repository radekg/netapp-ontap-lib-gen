...
class VolumeVmAlignAttributes(NetAppObject):
    """
    Information related to the Virtual Machine alignment settings on
    the volume.
    """
    ...
    def vm_align_sector(self):
        ...
        <512 * 'vm-align-sector'> bytes data at the beginning so
        that
        it's actual data starts at a different offset instead of
        zero.
    ...
    def vm_align_suffix(self):
        ...
        '.xyz'. is used to identify the files which needs to be
        aligned.
    ...
    @staticmethod
    def get_api_name():
          return "volume-vm-align-attributes"
