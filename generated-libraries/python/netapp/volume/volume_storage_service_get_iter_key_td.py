...
class VolumeStorageServiceGetIterKeyTd(NetAppObject):
    """
    Key typedef for table volume_storage_service
    """
    ...
    @staticmethod
    def get_api_name():
          return "volume-storage-service-get-iter-key-td"
