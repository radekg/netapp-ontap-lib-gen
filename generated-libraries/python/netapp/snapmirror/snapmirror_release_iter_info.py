from netapp.snapmirror.snapmirror_destination_info import SnapmirrorDestinationInfo
from netapp.netapp_object import NetAppObject

class SnapmirrorReleaseIterInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "snapmirror-release-iter-info"
    ...
    def describe_properties(self):
        return {
            'snapmirror_key': { 'class': SnapmirrorDestinationInfo, 'is_list': False, 'required': 'required' },
