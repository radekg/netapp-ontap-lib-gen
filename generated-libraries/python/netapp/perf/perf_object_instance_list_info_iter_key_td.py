...
class PerfObjectInstanceListInfoIterKeyTd(NetAppObject):
    """
    Key typedef for table perf_object_instance_list_info_zapi
    """
    ...
    @staticmethod
    def get_api_name():
          return "perf-object-instance-list-info-iter-key-td"
