...
class VscanConnectionStatusAllGetIterKeyTd(NetAppObject):
    """
    Key typedef for table vscan_connection_status_all_byname
    """
    ...
    @staticmethod
    def get_api_name():
          return "vscan-connection-status-all-get-iter-key-td"
