...
class VscanConnectionExtendedStatsGetIterKeyTd(NetAppObject):
    """
    Key typedef for table vscan_connection_extended_stats_byname
    """
    ...
    @staticmethod
    def get_api_name():
          return "vscan-connection-extended-stats-get-iter-key-td"
