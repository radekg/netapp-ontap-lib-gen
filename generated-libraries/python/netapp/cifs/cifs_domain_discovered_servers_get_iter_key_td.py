...
class CifsDomainDiscoveredServersGetIterKeyTd(NetAppObject):
    """
    Key typedef for table cifs_domain_discovered_server_byname
    """
    ...
    @staticmethod
    def get_api_name():
          return "cifs-domain-discovered-servers-get-iter-key-td"
