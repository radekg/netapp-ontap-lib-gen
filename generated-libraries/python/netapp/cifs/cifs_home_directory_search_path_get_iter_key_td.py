...
class CifsHomeDirectorySearchPathGetIterKeyTd(NetAppObject):
    """
    Key typedef for table cifs_homedir_searchpath_byname
    """
    ...
    @staticmethod
    def get_api_name():
          return "cifs-home-directory-search-path-get-iter-key-td"
