...
class SnapvaultSecondarySnapshotScheduleInfo(NetAppObject):
    """
    ...
    def schedule_name(self):
        """
        Uniquely identifies the schedule within a secondary
        volume. The schedule-name is used as a prefix in the
    ...
    def volume_name(self):
        """
        The secondary volume for which these schedules have
        been configured.
        """
    ...
    @staticmethod
    def get_api_name():
          return "snapvault-secondary-snapshot-schedule-info"
    ...
    def describe_properties(self):
        return {
            ...
            'is_auto_update': { 'class': bool, 'is_list': False, 'required': 'required' },
