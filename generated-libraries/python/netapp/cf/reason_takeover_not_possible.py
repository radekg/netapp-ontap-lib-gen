class ReasonTakeoverNotPossible(basestring):
    """
    Reason why takeover is not possible.
    <ul>
    ...
    <li>mailbox_invalid			- Partner mailbox disks not accessible or
    invalid</li>
    <li>mailbox_uninit			- Partner mailbox status uninitialized</li>
    <li>fm_version_mismatch			- Failover monitor version
    mismatch</li>
    ...
    <li>partner_revert_in_progress		- Partner is performing
    revert</li>
    ...
    <li>mailbox_uncertain			- Status of partner mailbox is
    uncertain</li>
    <li>no_auto_takeover			- Automatic takeover is disabled</li>
    <li>disk_inventory_not_exchanged	- Disk inventory information not
    received
    - from partner</li>
    <li>disk_inventory_mismatch_local	- Local node missing some of
    partner node's
    ...
    @staticmethod
    def get_api_name():
          return "reason-takeover-not-possible"
