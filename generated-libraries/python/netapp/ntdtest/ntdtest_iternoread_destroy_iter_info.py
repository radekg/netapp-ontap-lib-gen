...
class NtdtestIternoreadDestroyIterInfo(NetAppObject):
    """
    ...
    def ntdtest_iternoread_key(self):
        """
        The keys for the show noread object to which the deletion
        applies.
        """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-iternoread-destroy-iter-info"
