from netapp.ntdtest.ntdtest_multiple_alt_3 import NtdtestMultipleAlt3
from netapp.netapp_object import NetAppObject

class AlternateModifyIterInoutInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "alternate-modify-iter-inout-info"
    ...
    def describe_properties(self):
        return {
            'ntdtest_multiple_with_inout_key': { 'class': NtdtestMultipleAlt3, 'is_list': False, 'required': 'required' },
