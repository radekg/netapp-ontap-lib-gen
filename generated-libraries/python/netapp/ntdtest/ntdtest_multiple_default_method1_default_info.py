...
class NtdtestMultipleDefaultMethod1DefaultInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-multiple-default-method1-default-info"
    ...
    def describe_properties(self):
        return {
            'ntdtest_multiple_default_method1_key': { 'class': NtdtestMultipleGroupInfo, 'is_list': False, 'required': 'required' },
