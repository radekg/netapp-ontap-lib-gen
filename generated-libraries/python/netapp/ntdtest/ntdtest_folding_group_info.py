from netapp.ntdtest.group1_folding_info import Group1FoldingInfo
from netapp.netapp_object import NetAppObject

class NtdtestFoldingGroupInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-folding-group-info"
    ...
    def describe_properties(self):
        return {
            'group1_stats': { 'class': Group1FoldingInfo, 'is_list': True, 'required': 'optional' },
