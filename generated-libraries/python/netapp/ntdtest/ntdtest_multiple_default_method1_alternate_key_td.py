...
class NtdtestMultipleDefaultMethod1AlternateKeyTd(NetAppObject):
    """
    Key typedef for table ntdtest_multiple_with_default_method1
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-multiple-default-method1-alternate-key-td"
