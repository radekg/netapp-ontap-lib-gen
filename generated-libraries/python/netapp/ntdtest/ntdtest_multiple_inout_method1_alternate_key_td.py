...
class NtdtestMultipleInoutMethod1AlternateKeyTd(NetAppObject):
    """
    Key typedef for table ntdtest_multiple_with_inout_method1
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-multiple-inout-method1-alternate-key-td"
