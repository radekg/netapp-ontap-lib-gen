...
class NtdtestIterfromAltDestroyIterInfo(NetAppObject):
    """
    ...
    def ntdtest_iterfrom_alt_key(self):
        """
        The keys for the iter from object to which the deletion
        applies.
        """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-iterfrom-alt-destroy-iter-info"
