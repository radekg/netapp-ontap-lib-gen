from netapp.ntdtest.group2_multiple_info import Group2MultipleInfo
from netapp.netapp_object import NetAppObject

class Group1MultipleInfo(NetAppObject):
    """
    ...
    def describe_properties(self):
        return {
            'group4_stats': { 'class': Group2MultipleInfo, 'is_list': False, 'required': 'optional' },
