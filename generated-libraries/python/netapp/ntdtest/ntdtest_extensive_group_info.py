from netapp.ntdtest.group3_extensive_info import Group3ExtensiveInfo
from netapp.ntdtest.group1_extensive_info import Group1ExtensiveInfo
from netapp.ntdtest.group4_extensive_info import Group4ExtensiveInfo
from netapp.ntdtest.group2_extensive_info import Group2ExtensiveInfo
from netapp.netapp_object import NetAppObject

class NtdtestExtensiveGroupInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-extensive-group-info"
    ...
    def describe_properties(self):
        return {
            'group3_stats': { 'class': Group3ExtensiveInfo, 'is_list': False, 'required': 'optional' },
            'group1_stats': { 'class': Group1ExtensiveInfo, 'is_list': False, 'required': 'optional' },
            'group4_stats': { 'class': Group4ExtensiveInfo, 'is_list': False, 'required': 'optional' },
            'group2_stats': { 'class': Group2ExtensiveInfo, 'is_list': False, 'required': 'optional' },
        }
