...
class NtdtestFoldingMultipleArraysGetIterKeyTd(NetAppObject):
    """
    Key typedef for table ntdtest_folding_multiple_arrays
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-folding-multiple-arrays-get-iter-key-td"
