from netapp.ntdtest.group1_multiple_arrays_info import Group1MultipleArraysInfo
from netapp.netapp_object import NetAppObject

class NtdtestMultipleArraysGroupInfo(NetAppObject):
    """
    ...
    @staticmethod
    def get_api_name():
          return "ntdtest-multiple-arrays-group-info"
    ...
    def describe_properties(self):
        return {
            'group1_stats': { 'class': Group1MultipleArraysInfo, 'is_list': True, 'required': 'optional' },
