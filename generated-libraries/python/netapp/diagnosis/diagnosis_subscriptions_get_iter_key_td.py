...
class DiagnosisSubscriptionsGetIterKeyTd(NetAppObject):
    """
    Key typedef for table system_health_notify_sub
    """
    ...
    @staticmethod
    def get_api_name():
          return "diagnosis-subscriptions-get-iter-key-td"
