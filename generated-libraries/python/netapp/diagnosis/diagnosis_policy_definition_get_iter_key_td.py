...
class DiagnosisPolicyDefinitionGetIterKeyTd(NetAppObject):
    """
    Key typedef for table system_health_alert_policy
    """
    ...
    @staticmethod
    def get_api_name():
          return "diagnosis-policy-definition-get-iter-key-td"
